...
import { CreateInvestmentController } from "../modules/investment/useCase/create/CreateInvestmentController";
import { ListInvestmentController } from "../modules/investment/useCase/list/ListInvestmentController";
import { ListAssetNameInvestmentController } from "../modules/investment/useCase/listAssetName/ListAssetNameInvestmentController";
import { ListIdInvestmentController } from "../modules/investment/useCase/listId/ListIdInvestmentController";
import { ListUserBankIdInvestmentController } from "../modules/investment/useCase/listUserBankId/ListUserBankIdInvestmentController";
import { UpdateInvestmentController } from "../modules/investment/useCase/udpate/UpdateInvestmentController";
import { UpdatePriceInvestmentController } from "../modules/investment/useCase/updatePrice/UpdatePriceInvestmentController";
import { UpdateUserBankIdInvestmentController } from "../modules/investment/useCase/updateUserBankId/UpdateUserBankIdInvestmentController";
